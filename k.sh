...
VIP="com.pubg.krmobile"

am force-stop com.pubg.krmobile
killall -q com.pubg.krmobile
...
BP1=$(grep -n com.pubg.krmobile /data/system/users/0/settings_ssaid.xml | grep -o 'value="[a-zA-Z0-9]*"*' | cut -d '"' -f2)
...
lib=`ls -mR $(DUMP com.pubg.krmobile legacyNativeLibraryDir=) | grep : | tr -d : | grep /arm64 | grep -v sosna`
SAVE(){
cp $lib/$1 $lib/$1.bak
}
Fast(){
...
am start -S -W com.pubg.krmobile/com.epicgames.ue4.SplashActivity > /dev/null
while [ ! -e /data/media/0/Android/data/com.pubg.krmobile/files/TGPA ]; do sleep 1; done
sleep 1
RETURN libanogs.so
RETURN libgcloud.so
...
rm -rf /data/data/com.pubg.krmobile/app* 
 touch /data/data/com.pubg.krmobile/{app_bugly,app_crashrecord,app_crashSight}; 
 chmod 4000 /data/data/com.pubg.krmobile/{app_bugly,app_crashrecord,app_crashSight}; 
